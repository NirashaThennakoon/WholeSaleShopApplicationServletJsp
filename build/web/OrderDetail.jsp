    ...
    <body>
        ...
        <script type="text/javascript">
            $("#btnUpdate").click(function () {
                $("#frm").attr("action", "Servelet?action=update");
                $("#frm").submit();

                alert("ddd");
            });
            $("#btnDelete").click(function () {
                $("#frm").attr("action", "Servelet?action=delete");
                $("#frm").submit();

                alert("ddd");
            });
            $("#btnSearch").click(function () {
                $("#frm").attr("action", "Servelet?action=search");
                $("#frm").submit();

                function loadCustomerDetails(cusIdSelectBox) {
                    $.ajax({
                        url: Servlet.java,
